...
<html lang="en">
  <head>
    <title>BBloggers | Edit Blog</title>
  ...
  <div class="container">
   {{Form::Open(array('id'=>'newBlogForm','method'=>'POST','class'=>'form-horizontal'))}}
       ...
       <div class="form-group">
           ...
           <div class="col-sm-9">
               <textarea class="form-control summernote" name="content" id="content" style="height: 400px;" value="{{$blog->content}}"></textarea>
           </div>
       </div>

       <div class="form-group">
            <button type="submit" id="blogSubmit" class="btn btn-success col-lg-offset-3" onclick="editBlog()">Post</button>
       </div>
   {{Form::Close()}}
  </div>
